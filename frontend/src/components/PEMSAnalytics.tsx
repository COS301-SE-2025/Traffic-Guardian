...
const PEMSAnalytics: React.FC<PEMSAnalyticsProps> = ({ className = '' }) => {
  ...
  const [selectedView, setSelectedView] = useState<'overview' | 'districts' | 'alerts' | 'performance'>('overview');
  ...
  const fetchPEMSAnalytics = useCallback(async () => {
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to fetch PEMS data');
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  const getAlertsPriorityData = () => {
    ...
    return [
      { name: 'High Priority', value: priorities.high || 0, color: RISK_COLORS.CRITICAL },
      { name: 'Medium Priority', value: priorities.medium || 0, color: RISK_COLORS.MEDIUM },
      { name: 'Low Priority', value: priorities.low || 0, color: RISK_COLORS.LOW }
    ];
  };
  ...
  const getSystemHealthRadarData = () => {
    ...
    return metrics.map(metric => {
      ...
      districtData.slice(0, 5).forEach(district => {
        ...
        switch(metric) {
          case 'Speed':
            dataPoint[districtKey] = ((district.summary?.avg_speed || 0) / 70) * 100;
            break;
          case 'Flow':
            dataPoint[districtKey] = Math.min(((district.summary?.total_flow || 0) / 5000) * 100, 100);
            break;
          case 'Safety':
            dataPoint[districtKey] = 100 - ((district.summary?.avg_risk_score || 0) / 10) * 100;
            break;
          case 'Efficiency':
            dataPoint[districtKey] = ((district.summary?.active_detectors || 0) / (district.summary?.total_detectors || 1)) * 100;
            break;
        }
      });
      return dataPoint;
  ...
  if (loading) {
    return <LoadingSpinner size="large" text="Loading PEMS analytics..." className="content" />;
  }
            ...
            <div className="analytics-summary-cards">
              <div className="summary-card">
                ...
                <div className="card-content">
                  ...
                  <span className="card-subtitle">Monitoring California highways</span>
                </div>
              </div>
              ...
              <div className="summary-card">
                ...
                <div className="card-content">
                  <h3>{dashboardData?.overview?.avg_speed_mph?.toFixed(1) || 0} mph</h3>
                  <p>Average Speed</p>
                  <span className="card-subtitle">System-wide traffic flow</span>
                </div>
              </div>
            ...
            <div className="analytics-charts-grid">
              <div className="chart-container">
                ...
                <p className="chart-description">
                  Current distribution of traffic risk levels across all monitored detectors.
                  Critical and high-risk areas require immediate attention from traffic controllers.
                </p>
              ...
              <div className="chart-container">
                ...
                <p className="chart-description">
                  Performance metrics across California districts showing detector count and average speeds.
                  Higher speeds generally indicate better traffic flow.
                </p>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={getRegionalPerformanceData()}>
                    ...
                    <Tooltip />
                    <Bar yAxisId="left" dataKey="detectors" fill={PEMS_COLORS.primary} name="Detectors" />
                    <Bar yAxisId="right" dataKey="avgSpeed" fill={PEMS_COLORS.secondary} name="Avg Speed (mph)" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
        ...
        {selectedView === 'districts' && (
          <div className="districts-section">
            <div className="section-description">
              ...
              <p>
                Detailed analysis of traffic patterns across California districts. This data helps traffic 
                controllers understand regional differences and allocate resources effectively.
              </p>
            </div>
            ...
            <div className="analytics-charts-grid">
              <div className="chart-container full-width">
                ...
                <p className="chart-description">
                  Relationship between traffic speed and vehicle flow across districts. 
                  Optimal performance shows high speed with moderate flow rates.
                </p>
                  ...
                  <AreaChart data={getSpeedFlowData()}>
                    ...
                    <Tooltip 
                      ...
                      formatter={(value: any, name: string) => [
                        name === 'totalFlow' ? `${value}k vehicles/hr` : `${value} mph`,
              ...
              <div className="chart-container">
                ...
                <p className="chart-description">
                  Multi-dimensional view of district performance including speed, flow, safety, and efficiency metrics.
                </p>
                  ...
                  <RadarChart data={getSystemHealthRadarData()}>
                    ...
                    {districtData.slice(0, 5).map((district, index) => (
                      <Radar
                        ...
                        stroke={PEMS_COLORS.gradient[index % PEMS_COLORS.gradient.length]}
                        fill={PEMS_COLORS.gradient[index % PEMS_COLORS.gradient.length]}
                        fillOpacity={0.1}
                      />
                    ))}
                    <Tooltip />
        ...
        {selectedView === 'alerts' && (
          <div className="alerts-section">
            <div className="section-description">
              ...
              <p>
                Real-time alert distribution and critical area identification for proactive traffic management.
              </p>
            </div>
            ...
            <div className="analytics-charts-grid">
              <div className="chart-container">
                ...
                <p className="chart-description">
                  Current breakdown of active alerts by priority level. High-priority alerts require immediate response.
                </p>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
              ...
              <div className="chart-container">
                ...
                <p className="chart-description">
                  Number of high-risk areas and active alerts per region, helping prioritize resource deployment.
                </p>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={getRegionalPerformanceData()}>
                    <CartesianGrid strokeDasharray="3 3" />
                    ...
                    <YAxis />
                    <Tooltip />
                    <Bar dataKey="highRisk" fill={RISK_COLORS.HIGH} name="High Risk Areas" />
                    <Bar dataKey="alerts" fill={RISK_COLORS.CRITICAL} name="Active Alerts" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
            ...
            {highRiskData?.high_risk_areas?.length > 0 && (
              <div className="high-risk-areas-list">
                ...
                <div className="risk-areas-grid">
                  {highRiskData.high_risk_areas.slice(0, 6).map((area: any, index: number) => (
                    <div key={index} className="risk-area-card">
                      <div className="area-header">
                        <span className="detector-id">{area.detector_id}</span>
                        <span className={`risk-badge ${area.risk_level?.toLowerCase()}`}>
                          {area.risk_level}
                        </span>
                      </div>
                      ...
                      <div className="area-metrics">
                        <span>Risk Score: {area.risk_score?.toFixed(1)}/10</span>
        ...
        {selectedView === 'performance' && (
          <div className="performance-section">
            <div className="section-description">
              ...
              <p>
                Detailed performance analysis showing traffic flow efficiency and system utilization across the network.
              </p>
            </div>
            ...
            <div className="analytics-charts-grid">
              <div className="chart-container full-width">
                ...
                <p className="chart-description">
                  Traffic detector performance across regions showing speed and occupancy trends.
                </p>
                <ResponsiveContainer width="100%" height={350}>
                ...
                <div className="insights-list">
                  <div className="insight-item">
                    ...
                    <div className="insight-content">
                      ...
                      <p>
                        {dashboardData?.overview?.total_detectors || 0} detectors are actively monitoring 
                        California highways with an average speed of {dashboardData?.overview?.avg_speed_mph?.toFixed(1) || 0} mph.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="insight-item">
                    ...
                    <div className="insight-content">
                      ...
                      <p>
                        {dashboardData?.overview?.high_risk_count || 0} areas currently require attention, 
                        with {alertsData?.priority_breakdown?.high || 0} high-priority alerts active.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="insight-item">
                    ...
                    <div className="insight-content">
                      ...
                      <p>
                        Monitoring spans {dashboardData?.regional_status?.length || 0} major California districts 
                        with comprehensive coverage of urban and suburban highways.
                      </p>
                    </div>
                  </div>
                </div>
