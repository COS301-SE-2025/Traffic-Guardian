...
const Analytics: React.FC = () => {
  ...
  // Simulated data loaders - replace with real API calls
        ...
        <div className="summary-cards">
            ...
            <div className="card-content">
              ...
              <div
                className={`card-trend ${
                  summaryStats.trendsComparison.incidents >= 0 ? 'up' : 'down'
                }`}
              >
                {summaryStats.trendsComparison.incidents >= 0 ? (
                  <TrendingUpIcon />
                ) : (
                  <TrendingDownIcon />
                )}
          ...
          <div className="summary-card">
            ...
            <div className="card-content">
              ...
              <div
                className={`card-trend ${
                  summaryStats.trendsComparison.responseTime <= 0 ? 'up' : 'down'
                }`}
              >
                {summaryStats.trendsComparison.responseTime <= 0 ? (
                  <TrendingUpIcon />
                ) : (
                  <TrendingDownIcon />
                )}
          ...
          <div className="summary-card">
            ...
            <div className="card-content">
              ...
              <div
                className={`card-trend ${
                  summaryStats.trendsComparison.resolution >= 0 ? 'up' : 'down'
                }`}
              >
                {summaryStats.trendsComparison.resolution >= 0 ? (
                  <TrendingUpIcon />
                ) : (
                  <TrendingDownIcon />
                )}
